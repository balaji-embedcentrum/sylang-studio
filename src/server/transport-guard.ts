 ...
 * isn't safe for it. Same policy used by clone (token in clone body) and by
 * the session claim (per-claim github_token hand-off).
 *
 ...
 * ClaimResult from the session manager, etc.) — this just throws.
 */
