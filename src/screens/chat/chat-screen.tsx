...
export function ChatScreen({
  ...
  const sendMessage = useCallback(
    function sendMessage(
      ...
      // For new chats, send NO history — clean slate
      const isNewSession = sessionKey === 'new' || sessionKey.startsWith('new-') || isNewChat
      const history = isNewSession ? [] : buildPortableHistory(finalDisplayMessages)
      ...
      void startStreaming({
        ...
        localAgentUrl: localHermesUrl || undefined,
        localWorkspaceRoot: localWorkspaceRoot || undefined,
      }).catch((err: unknown) => {
